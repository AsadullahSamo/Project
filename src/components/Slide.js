...
const renderButtons = () => {
    switch (props.activeIndex) {
      case 5: // For slide 5
        return (
          <div className='text-center'>
            <h1 className={`${styles.fontFamily} text-slate-300 text-[33px] text-center font-semibold`}> Excerpts </h1> 
            <br />
            <h1 className={`${styles.fontFamily} text-slate-300 text-[33px] text-center font-semibold`}> Rat Park </h1> 
            <ul className='m-2 flex mr-12 justify-evenly gap-7 flex-wrap mb-5'>
            ...
            <ul className='m-2 flex justify-center gap-5 flex-wrap mb-5'>
      ...
      return (
          <div className='text-center'>
            <h1 className={`${styles.fontFamily} text-white text-[33px] text-center font-semibold`}> Podcasts </h1> 
            <br />
            <p className={`${styles.fontFamily} text-white text-[33px] text-center font-semibold`}> Rare Bird Radio - Conversation with Tyler Knight </p> 
            <ul className='mb-10 flex justify-start gap-3'>
            ...
            <ul className='flex justify-start gap-3 mb-10'>
            ...
            <ul className='m-2 flex justify-start gap-3 mb-5'>
      ...
      case 7: // For slide 8
        return (
          <div className='text-justify mt-36'>
            ...
            <p className={`${styles.fontFamily} text-slate-200 text-[40px] w-[80%] font-semibold`}> Show your support and nab some Swag! </p> 
            <br />
            <ul className='flex justify-start gap-3 mb-10'>
      ...
      case 8: // For slide 8
        return (
          <div className='text-justify mt-36'>
            ...
            <p className={`${styles.fontFamily} text-slate-200 text-[20px] text-center m-auto w-[80%] font-semibold`}> Adam Novak is the author of the novels Rat Park, The Non-Pro, Freaks of the Industry, and Take Fountain. He divides his time between Beachwood Canyon and Fort Washington, Maryland. </p> 
            <br />
            <ul className='flex justify-start gap-3 mb-10'>
  ...
  return (
    <>
      ...
      <section className={`w-[79%] bg-[${props.bgColorSection2}] flex flex-col justify-center`}> {/* h-[93vh]  w-[79%]*/}
        ...
        <p className={`${styles.margin} ${styles.font} md:pt-10 md:text-slate-300 w-[80%]`}>{props.pText}</p>         
