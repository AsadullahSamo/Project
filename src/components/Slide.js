      ...
      case 7: // For slide 8
        return (
          <div className='text-center mt-36'>
            ...
            <p className={`${styles.fontFamily} m-auto text-slate-200 text-[40px] w-[80%] font-semibold`}> Show your support and nab some Swag! </p> 
            <br />
            <ul className={`flex justify-start gap-3 mb-10 ${styles.btnUl}`}>
...
const [prevIndex, setPrevIndex] = useState(0);
  ...
  return (
    <>
      ...
      <section className={`${styles.section2Margin} w-[79%] bg-[${props.bgColorSection2}] flex flex-col justify-center`}> {/* h-[93vh]  w-[79%]*/}
